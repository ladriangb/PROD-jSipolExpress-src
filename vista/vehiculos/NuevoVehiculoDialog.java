...
public class NuevoVehiculoDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        labelControl3.setLabel("serialCarroceria");
        labelControl3.setToolTipText("Numero de Placa del Vehiculo");

        textControl2.setAttributeName("serialCarroceria");
            ...
            .addGroup(form1Layout.createSequentialGroup()
                ...
                .addGroup(form1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(form1Layout.createSequentialGroup()
                        ...
                        .addComponent(textControl1, javax.swing.GroupLayout.DEFAULT_SIZE, 179, Short.MAX_VALUE))
                    .addGroup(form1Layout.createSequentialGroup()
                        .addComponent(labelControl3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(textControl2, javax.swing.GroupLayout.DEFAULT_SIZE, 179, Short.MAX_VALUE)))
                .addContainerGap())
        );
        ...
        form1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {labelControl2, labelControl3, textControl2});
    ...
    class VehiculoDialogController extends FormController {
        ...
        public Response insertRecord(ValueObject newPersistentObject) throws Exception {
            ...
            try {
                ...
                Long cant = (Long) s.createQuery("SELECT count(P) FROM " + Vehiculo.class.getName() + " as P WHERE "
                        + "P.placa=? OR P.serialCarroceria=?").
                        setString(0, vehiculo.getPlaca()).setString(1, vehiculo.getSerialCarroceria()).
                        list().get(0);
                if (cant == 0) {
                    vehiculo = (Vehiculo) newPersistentObject;
                    ...
                    ok = true;
                    nuevo = false;
                    vehiculo = (Vehiculo) s.createQuery("SELECT P FROM " + Vehiculo.class.getName() + " as P WHERE "
                            + "P.placa=? OR P.serialCarroceria=?").
                            setString(0, vehiculo.getPlaca()).setString(1, vehiculo.getSerialCarroceria()).
                            uniqueResult();
                    ...
                    ok = false;
                    return new ErrorResponse("Existen " + cant + " Vehiculos con que cumplen con la informacion ingresada.\nRevise la información.");
                }
            } catch (Exception ex) {
                ok = false;
                ex.printStackTrace();
