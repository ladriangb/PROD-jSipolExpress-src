...
public class PersonaDetailFrame extends DefaultDetailFrame {
    ...
    private void initComponents() {
        ...
        gridSMS = new org.openswing.swing.client.GridControl();
        ...
        gridSMS.setMaxNumberOfRowsOnInsert(4);
        gridSMS.setNavBar(navigatorBar1);
        gridSMS.setReloadButton(reloadButton12);
        gridSMS.setValueObjectClassName(SMS.class.getName());

        decimalColumn11.setColumnName("id");
        decimalColumn11.setColumnRequired(false);
        decimalColumn11.setPreferredWidth(40);
        gridSMS.getColumnContainer().add(decimalColumn11);

        textColumn19.setColumnName("texto");
        textColumn19.setEditableOnEdit(true);
        textColumn19.setEditableOnInsert(true);
        gridSMS.getColumnContainer().add(textColumn19);
        ...
        gridSMS.getColumnContainer().add(textColumn20);
        ...
        gridSMS.getColumnContainer().add(textColumn21);
        ...
        gridSMS.getColumnContainer().add(textColumn10);
        ...
        gridSMS.getColumnContainer().add(dateTimeColumn2);
        ...
        jPanel31Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel31Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(gridSMS, javax.swing.GroupLayout.DEFAULT_SIZE, 568, Short.MAX_VALUE))
        );
        jPanel31Layout.setVerticalGroup(
            jPanel31Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel31Layout.createSequentialGroup()
                .addGroup(jPanel31Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(gridSMS, javax.swing.GroupLayout.PREFERRED_SIZE, 447, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public void inicializar(FormController formController, boolean addToMDIFrame) {
        ...
        controllerSMSs= new SMSInternalGridController(Persona.class.getName(), "getSmss", gridSMS, null);
        gridSMS.setGridDataLocator(controllerSMSs);
        gridSMS.setController(controllerSMSs);
...
//        comboBoxVOControl1.setPreferredWidthColumn("nombre", 120);
    ...
    private org.openswing.swing.client.GridControl gridSMS;
