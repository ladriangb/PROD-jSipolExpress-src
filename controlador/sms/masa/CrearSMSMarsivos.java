...
//                es.setVisible(true);
                ...
                try {
                    ...
                    for (Object o : ((VOListResponse) res).getRows()) {
                        ...
                        crearLista(lista2, p, nombreProductor, motivo, msj2, new Date(), ab,s);
                    }
                    lista = lista2;
                } catch (Exception ex) {
                    ex.printStackTrace();
...
//                es.setVisible(true);
                ...
                try {
                    ...
                    for (Object o : l) {
                        ...
                        msj2 = msj2.replaceAll(":nombreLargo", p.getNombreLargo());
                        msj2 = msj2.replaceAll(":nombre", p.getNombreCorto());
                        crearLista(lista2, p, nombreProductor, motivo, msj2, fecha, ab,s);
                    }
                    lista = lista2;
                } catch (Exception e) {
                    e.printStackTrace();
...
//                es.setVisible(true);
                ...
                try {
                    ...
                    for (Object o : l) {
                        ...
                        crearLista(lista2, p, nombreProductor, motivo, msj2, p.getFechaNacimiento(), ab,s);
                    }
...
//                es.setVisible(true);
                ...
                try {
                    ...
                    for (Object o : l) {
                        ...
                        c.setTime(d.getFechaVencimiento());
                        msj2 = msj2.replaceAll(":fecha", c.get(Calendar.DATE) + "/" + c.get(Calendar.MONTH) + "/" + c.get(Calendar.YEAR));
                        crearLista(lista2, p, nombreProductor, motivo, msj2, d.getFechaVencimiento(), ab,s);
                    }
                    lista = lista2;
                } catch (Exception e) {
                    e.printStackTrace();
...
//                es.setVisible(true);
                ...
                try {
                    ...
                    for (Object o : l) {
                        ...
                        c.setTime(g.getFechaVencimiento());
                        msj2 = msj2.replaceAll(":fecha", c.get(Calendar.DATE) + "/" + c.get(Calendar.MONTH) + "/" + c.get(Calendar.YEAR));
                        crearLista(lista2, p, nombreProductor, motivo, msj2, g.getFechaVencimiento(), ab,s);
                    }
                    lista = lista2;
                } catch (Exception e) {
                    e.printStackTrace();
...
//                es.setVisible(true);
                ...
                try {
                    ...
                    for (Object o : l) {
                        ...
                        c.setTime(r.getVigenciaHasta());
                        msj2 = msj2.replaceAll(":fecha", c.get(Calendar.DATE) + "/" + c.get(Calendar.MONTH) + "/" + c.get(Calendar.YEAR));
                        crearLista(lista2, p, nombreProductor, motivo, msj2, r.getVigenciaHasta(), ab,s);
                    }
                    lista = lista2;
                } catch (Exception e) {
                    e.printStackTrace();
...
//        es.dispose();
    ...
    private void crearLista(Set<SMS> lista, Persona p, String nombreProductor, String motivo, String msj, Date fecha, AuditoriaBasica ab,Session s) {
        boolean marco = false;
        if (!p.getTelefonos().isEmpty()) {
            for (TelefonoPersona tel : p.getTelefonos()) {
                if (tel.isNotificar()) {
                    marco = true;
                    SMS sa=new SMS(p.getNombreLargo(), nombreProductor, "0" + tel.getNumeroCompleto(), motivo, msj, fecha, EstatusSMS.PENDIENTE, ab,p);
                    s.save(sa);
                    lista.add(sa);
                }
            }
        ...
        if (!marco) {
            SMS sa=new SMS(p.getNombreLargo(), nombreProductor, "S/N", motivo, msj, fecha, EstatusSMS.SIN_NUMERO, ab,p);
            s.save(sa);
            lista.add(sa);
        }
    }
